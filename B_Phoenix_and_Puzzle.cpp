...
//Function to return the count of set bits in n in O(1)
...
//Determination of total number of set bits of an integer
...
void solve(){
    ...
    cin>>n;
    ll temp=n/2,t2=n/4;
    if(ceil((double)sqrt(temp))==floor((double)sqrt(temp)) && n%2==0)
       cout<<"YES"<<endl;
    else if(ceil((double)sqrt(t2))==floor((double)sqrt(t2)) && n%4==0)
       cout<<"YES"<<endl;
    else  
       cout<<"NO"<<endl;
    return;
