...
/*Editorial:In this problem, you should notice that the answer for the problem is always of the following form: n, 1, 2, 3, ..., n-1. In such case array will be always sorted after the end of the algorithm.*/
void solve(){
    int n;
    cin>>n;
    cout<<n<<" ";
