...
/* Editorial: The string is diverse if it is a permutation of some substring of the Latin alphabet ("abcd ... xyz").
...
void solve(){
    ...
    FOR(i,n)
    {
        ...
        int diff=*max_element(s.begin(),s.end())-*min_element(s.begin(),s.end())+1;
        if(diff==s.length())
           cout<<"Yes"<<endl;
        else 
           cout<<"No"<<endl;
